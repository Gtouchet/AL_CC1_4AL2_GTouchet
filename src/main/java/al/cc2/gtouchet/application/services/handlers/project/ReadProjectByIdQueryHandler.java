...
public final class ReadProjectByIdQueryHandler implements QueryHandler<Project, ReadProjectQuery>
{
    private final Repository<Project> projectRepository;

    public ReadProjectByIdQueryHandler(Repository projectRepository)
    {
